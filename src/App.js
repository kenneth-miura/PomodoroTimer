...
function App() {
  ...
  const [pomodoroDuration, setPomodoroDuration] = useState(52)
  const [breakDuration, setBreakDuration] = useState(8)
  ...
  return (
    <div>
      ...
      <SettingsModal
        ...
        defaultPomodoro={pomodoroDuration}
        defaultBreak={breakDuration}
        savePomodoroDuration={setPomodoroDuration}
        saveBreakDuration={setBreakDuration}
      >
      </SettingsModal>
      <DataVisualizationModal
        showModal={showDataModal}
        onCloseModal={() => setShowDataModal(false)}
      ></DataVisualizationModal>
      <Timer pomodoroDuration={pomodoroDuration} breakDuration={breakDuration}></Timer>
    </div>
  );
}
